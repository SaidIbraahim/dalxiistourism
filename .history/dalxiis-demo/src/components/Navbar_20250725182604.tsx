...
// Language toggle state (to be moved to context for full i18n support)
...
const Navbar = () => {
  ...
  const handleLangToggle = () => {
    ...
    // In a full implementation, update context/provider here
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center text-sm">
            ...
            <button
              ...
              className="ml-4 px-3 py-1 rounded-full bg-[#f29520] text-white font-semibold text-xs hover:bg-[#e08420] transition-colors"
              aria-label="Toggle language"
            >
              {lang === 'en' ? 'English' : 'Soomaali'}
            </button>
          </div>
        </div>
      </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button
                onClick={handleLangToggle}
                className="w-full mt-2 px-3 py-2 rounded-md bg-[#f29520] text-white font-semibold text-base hover:bg-[#e08420] transition-colors"
                aria-label="Toggle language"
              >
                {lang === 'en' ? 'English' : 'Soomaali'}
              </button>
