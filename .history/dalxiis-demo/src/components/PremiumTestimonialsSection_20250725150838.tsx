  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: 'Dalxiis Tourism exceeded every expectation. The attention to detail and local knowledge of our guide was exceptional. The VIP package to Bosaso was absolutely perfect - from the luxury accommodation to the exclusive beach access. This was truly a five-star experience that I\'ll never forget.',
    ...
    },
    {
      ...
      role: 'Travel Blogger',
      rating: 5,
      text: 'As someone who has traveled to over 50 countries, I can honestly say that Dalxiis Tourism provided one of the most authentic and well-organized experiences I\'ve ever had. The cultural immersion in Eyl was breathtaking, and the team\'s professionalism was outstanding throughout.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'My family and I had the most incredible vacation with Dalxiis Tourism. They handled every detail perfectly - from airport transfers to the amazing accommodations. Our children are still talking about the boat rides and traditional music performances. Truly world-class service!',
    ...
    },
    {
      ...
      rating: 5,
      text: 'The depth of cultural knowledge and respect shown by the Dalxiis team was remarkable. They connected me with local artisans and historians, providing insights I couldn\'t have gained anywhere else. This wasn\'t just tourism - it was cultural education at its finest.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'Dalxiis Tourism gave me access to the most stunning and untouched locations I\'ve ever photographed. Their local connections and expertise opened doors to experiences that would be impossible to arrange independently. The Puntland Explorer package was beyond my wildest expectations.',
      image: 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=300',
    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          <a
            href="https://wa.me/252905345879?text=Hi! I'd like to share my experience with Dalxiis Tourism and possibly book another trip."
            target="_blank"
