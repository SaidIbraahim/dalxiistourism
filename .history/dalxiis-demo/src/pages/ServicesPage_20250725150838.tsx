  ...
  const services = [
    {
      ...
      description: 'Professional airport transfer services available 24/7 for all major airports in Puntland including Garowe, Bosaso, and Galkaio.',
      features: [
        '24/7 Availability',
    ...
    },
    {
      ...
      description: 'Book premium accommodations with our trusted hotel partners across Puntland. We handle all bookings on behalf of our customers.',
      features: [
    ...
    },
    {
      ...
      description: 'Modern fleet of well-maintained vehicles for your transportation needs throughout Puntland region.',
      features: [
    ...
    },
    {
      ...
      description: 'Comprehensive tour planning services including city tours, regional tours, and custom itineraries designed to showcase Puntland\'s beauty.',
      features: [
    ...
    },
    {
      ...
      description: 'Complete visa and immigration support for international travelers visiting Somalia and Puntland region.',
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive travel solutions designed to make your journey through Puntland 
        ...
        <div className="bg-[#1c2c54] text-white rounded-2xl p-8 text-center mb-8">
          ...
          <p className="text-xl mb-6 opacity-90">
            Our travel experts are ready to help you plan the perfect trip to Puntland
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => window.open('https://wa.me/252905345879?text=Hi! I need help choosing the right services for my trip to Puntland.', '_blank')}
