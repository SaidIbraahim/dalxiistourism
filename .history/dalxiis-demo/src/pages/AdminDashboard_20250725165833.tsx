...
import DestinationsSection from './admin/DestinationsSection';
      ...
      <div className="flex flex-col min-h-screen transition-all duration-300 md:ml-60" style={{ maxWidth: '100vw' }}>
        ...
        <main className="flex-1 p-2 md:p-4 bg-gray-50">
          ...
          {activeTab === 'destinations' && (
            <DestinationsSection destinations={destinations} setDestinations={setDestinations} />
          )}
          {activeTab === 'analytics' && (
            <AnalyticsSection analytics={analytics} setAnalytics={setAnalytics} />
          )}
        </main>
      </div>
    </div>
