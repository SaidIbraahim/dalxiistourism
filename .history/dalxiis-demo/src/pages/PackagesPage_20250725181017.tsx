            ...
            <div key={pkg.id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300">
              <div className="md:flex">
                ...
                <div className="md:w-1/2 p-3">
                  <h3 className="text-xl font-bold text-[#1c2c54] mb-1">{pkg.name}</h3>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="bg-[#2f67b5] text-white px-4 py-2 rounded-full font-semibold hover:bg-[#1c2c54] transition-colors text-sm"
                    >
                      Book Now
                    </button>
                  </div>
