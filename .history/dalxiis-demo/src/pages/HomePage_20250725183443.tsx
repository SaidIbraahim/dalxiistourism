...
const HomePage = () => {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-r from-[#2f67b5] via-[#1c2c54] to-[#2f67b5] relative overflow-hidden">
        {/* Background Pattern */}
            ...
            {[
              ...
              <div key={index} className="text-center group">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl border border-white/20">
                  <div className="w-16 h-16 bg-[#f29520] rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                    <stat.icon className="h-8 w-8 text-white" />
                  </div>
                  <div className="text-4xl font-bold text-white mb-2">{stat.number}</div>
                  <div className="text-lg font-semibold text-[#f29520] mb-2">{stat.label}</div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-[#f29520]/10 text-[#f29520] px-6 py-3 rounded-full mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 hover:border-[#f29520]/20">
                  <div className={`w-16 h-16 bg-gradient-to-r ${feature.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                    <feature.icon className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-[#1c2c54] mb-4">{feature.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <a
                href="https://wa.me/252905345879?text=Hi! I'm interested in planning a trip to Somalia. Can you help me get started?"
                target="_blank"
                rel="noopener noreferrer"
                className="group border-2 border-[#f29520] text-[#f29520] px-10 py-5 rounded-full font-bold text-lg hover:bg-[#f29520] hover:text-white transition-all duration-500 inline-flex items-center justify-center transform hover:scale-105 hover:-translate-y-1 backdrop-blur-sm"
              >
                Start Planning Now
              </a>
            </div>
            ...
            <div className="mt-12 flex flex-wrap justify-center items-center gap-8 opacity-80">
              <div className="flex items-center">
                <Shield className="h-5 w-5 mr-2 text-[#f29520]" />
                <span className="text-sm">100% Safe & Secure</span>
              </div>
              <div className="flex items-center">
                <Star className="h-5 w-5 mr-2 text-[#f29520]" />
                <span className="text-sm">4.9/5 Customer Rating</span>
              </div>
              <div className="flex items-center">
                <Users className="h-5 w-5 mr-2 text-[#f29520]" />
