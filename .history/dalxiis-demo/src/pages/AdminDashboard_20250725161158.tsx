...
// Pagination helper
function usePagination(data: any[], itemsPerPage = 5) {
...
const AdminDashboard = () => {
  ...
  const renderPackages = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {packagesPagination.paginated.map((pkg) => (
      ...
      <div className="flex justify-center items-center gap-2 mt-4">
        <button onClick={() => packagesPagination.goTo(packagesPagination.page - 1)} disabled={packagesPagination.page === 1} className="px-3 py-1 rounded bg-gray-100 text-gray-500 hover:bg-gray-200 disabled:opacity-50">Prev</button>
        <span className="text-sm font-medium">Page {packagesPagination.page} of {packagesPagination.maxPage}</span>
        <button onClick={() => packagesPagination.goTo(packagesPagination.page + 1)} disabled={packagesPagination.page === packagesPagination.maxPage} className="px-3 py-1 rounded bg-gray-100 text-gray-500 hover:bg-gray-200 disabled:opacity-50">Next</button>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="flex justify-center items-center gap-2 py-4 border-t border-gray-100">
          <button onClick={() => bookingsPagination.goTo(bookingsPagination.page - 1)} disabled={bookingsPagination.page === 1} className="px-3 py-1 rounded bg-gray-100 text-gray-500 hover:bg-gray-200 disabled:opacity-50">Prev</button>
          <span className="text-sm font-medium">Page {bookingsPagination.page} of {bookingsPagination.maxPage}</span>
          <button onClick={() => bookingsPagination.goTo(bookingsPagination.page + 1)} disabled={bookingsPagination.page === bookingsPagination.maxPage} className="px-3 py-1 rounded bg-gray-100 text-gray-500 hover:bg-gray-200 disabled:opacity-50">Next</button>
        </div>
      </div>
    </div>
  );
  ...
  const renderClientRequests = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        {requestsPagination.paginated.map((request) => (
      ...
      {/* Pagination Controls */}
      <div className="flex justify-center items-center gap-2 mt-4">
        <button onClick={() => requestsPagination.goTo(requestsPagination.page - 1)} disabled={requestsPagination.page === 1} className="px-3 py-1 rounded bg-gray-100 text-gray-500 hover:bg-gray-200 disabled:opacity-50">Prev</button>
        <span className="text-sm font-medium">Page {requestsPagination.page} of {requestsPagination.maxPage}</span>
        <button onClick={() => requestsPagination.goTo(requestsPagination.page + 1)} disabled={requestsPagination.page === requestsPagination.maxPage} className="px-3 py-1 rounded bg-gray-100 text-gray-500 hover:bg-gray-200 disabled:opacity-50">Next</button>
      </div>
    </div>
  );
  ...
  // Pagination for bookings, packages, client requests
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Colored Sidebar */}
      <aside className="fixed md:static z-30 top-0 left-0 h-full md:h-auto w-60 bg-gradient-to-b from-[#2f67b5] to-[#f29520] flex flex-col justify-between transition-all duration-300 shadow-none md:shadow-lg">
        <div>
          {/* Logo & Title */}
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col md:ml-60 min-h-screen" style={{maxWidth: '100vw'}}>
        {/* Header */}
