      ...
      <div className="w-64 bg-white shadow-lg">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <div className="text-lg font-bold text-[#1c2c54]">Dalxiis</div>
              <div className="text-sm text-[#f29520]">Admin Panel</div>
            </div>
          </div>
        </div>
          ...
          {sidebarItems.map((item) => (
            <button
              ...
              className={`w-full flex items-center px-4 py-3 mb-2 text-left rounded-lg transition-all duration-200 ${
                activeTab === item.id 
                  ? 'bg-gradient-to-r from-[#f29520] to-[#e08420] text-white shadow-lg' 
        ...
        <div className="absolute bottom-6 left-3 right-3">
          <button
            ...
            className="flex items-center justify-center w-full bg-gray-100 text-gray-600 px-4 py-3 rounded-lg hover:bg-red-50 hover:text-red-600 transition-colors font-medium"
          >
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage your tourism business</p>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f29520] focus:border-transparent"
                />
              </div>
                      ...
                      {clientRequests.filter(r => r.status === 'new').map(request => (
                        <div key={request.id} className="p-4 border-b border-gray-100 hover:bg-gray-50">
                          <div className="flex items-start">
                            ...
                            <div className="flex-1">
                              <p className="text-sm font-medium text-gray-900">New request from {request.name}</p>
                              <p className="text-xs text-gray-600">{request.subject}</p>
        ...
        <main className="flex-1 p-6">
          ...
          {activeTab === 'services' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button className="bg-[#f29520] text-white px-4 py-2 rounded-lg hover:bg-[#e08420] transition-colors flex items-center">
                  <Plus className="h-4 w-4 mr-2" />
                  Add Service
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {services.map((service) => (
                  <div key={service.id} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                    ...
                    <div className="flex items-center space-x-2">
                      <button className="flex-1 bg-[#2f67b5] text-white px-4 py-2 rounded-lg hover:bg-[#1c2c54] transition-colors text-sm">
                        Manage Service
                      </button>
          ...
          {activeTab === 'destinations' && (
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Destinations Management</h3>
              <p className="text-gray-600">Destination content management system would be implemented here</p>
            </div>
          )}
          {activeTab === 'analytics' && (
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600">Detailed analytics and reporting dashboard would be implemented here</p>
            </div>
          )}
        </main>
      </div>
