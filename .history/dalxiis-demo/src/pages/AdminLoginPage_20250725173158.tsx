  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1c2c54] via-[#2f67b5] to-[#1c2c54] p-2">
      <div className="w-full max-w-md mx-auto flex flex-col items-center justify-center min-h-[70vh]">
        ...
        <Link
          to="/"
          className="inline-flex items-center text-white hover:text-[#f29520] transition-colors mb-4"
        >
          <ArrowLeft className="h-5 w-5 mr-2" />
          Back to Home
        </Link>
        {/* Login Card */}
        <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-6 border border-white/20 w-full">
          {/* Header */}
          <div className="text-center mb-4">
            <div className="w-14 h-14 bg-gradient-to-br from-[#f29520] to-[#e08420] rounded-full flex items-center justify-center mx-auto mb-2">
          ...
          {/* Demo Credentials */}
          <div className="mt-3 p-2 bg-[#f29520]/20 border border-[#f29520]/30 rounded-lg">
